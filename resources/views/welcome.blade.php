...
<body>
    <header>
        <div class="container">
            <h1 class="logo">
                Saturday<span>Learn</span>
            </h1>
            <section class="social">
                @if (Route::has('login'))
                    @auth
                        <a class="btn" href="{{ url("/{$currentUser->type}") }}">Trang chủ</a>
                    @else
                        <a class="btn" href="{{ route('login') }}">Đăng nhập</a>
        
                        @if (Route::has('register'))
                            <a class="btn" href="{{ route('register') }}">Đăng ký</a>
                        @endif
                    @endauth
                @endif
            </section>
...
<path fill="#FFFFFF" d="M19.998,6.766l-5.759-0.544c-0.362-0.032-0.676-0.264-0.822-0.61l-2.064-4.999
    ...
    c-0.081-0.365,0.035-0.729,0.313-0.975l4.34-3.811C21.219,7.921,20.855,6.848,19.998,6.766z"/>
                ...
                <div class="timeline-content">
                    <h2>Đặt lịch</h2>
                    <p>
                        Sinh viên tạo lịch học mong muốn.
                    </p>
                </div>
            </div>
...
<path fill="#FFFFFF" d="M19.998,6.766l-5.759-0.544c-0.362-0.032-0.676-0.264-0.822-0.61l-2.064-4.999
    ...
    c-0.081-0.365,0.035-0.729,0.313-0.975l4.34-3.811C21.219,7.921,20.855,6.848,19.998,6.766z"/>
                ...
                <div class="timeline-content">
                    <h2>Đánh giá</h2>
                    <p>
                        Sinh viên và giáo viên đánh giá về buổi học.
                    </p>
                </div>
            </div>
        </div>
